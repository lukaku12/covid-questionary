    ...
    submitForm() {
      ...
      const sendData = {
        ...
        ...(state.CovidState.had_covid === "yes" && {
          ...
          ...(state.CovidState.had_antibody_test === "no" && {
            covid_sickness_date: state.CovidState.covid_date.replace(/-/g, "/"),
          }),
        }),

        had_vaccine: state.AreYouVaccinated.had_vaccine === "yes",
        ...(state.AreYouVaccinated.had_vaccine === "yes" && {
          vaccination_stage: state.AreYouVaccinated.vaccination_stage,
        }),
        ...(state.AreYouVaccinated.had_vaccine === "no" && {
          i_am_waiting: state.AreYouVaccinated.what_are_you_waiting_for,
        }),
